import pandas as pd
from validator import validate_add_item, validate_update_item_name, validate_update_item_qty, validate_update_item_price
    ...
    def update_item_name(self, item_name, new_item_name):
        try:
            if validate_update_item_name(item_name, new_item_name):
                # pemindahan item dari "self.items" yang memiliki nama "item_name" ke item baru yang memiliki nama "new_item_name".
                # Method pop() akan menghapus item dari dictionary dan mengembalikan nilai dari item yang dihapus.
